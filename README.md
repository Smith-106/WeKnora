...
<p align="center">
    ...
    <a href="./CHANGELOG.md">
        <img alt="Version" src="https://img.shields.io/badge/version-0.8.1-2e6cc4?labelColor=d4eaf7">
    </a>
</p>
...
- **v0.8.1** — **Retrieval performance** (BM25 keyword result cache with corpus-version invalidation; embedding retry/LRU/singleflight; `ivfflat.probes=8` for high-dimensional vectors; de-flaked cache tests). Plus repository hygiene: no longer tracking local deployment artifacts. See [`CHANGELOG.md`](./CHANGELOG.md).
