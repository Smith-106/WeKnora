...
<p align="center">
    ...
    <a href="./CHANGELOG.md">
        <img alt="バージョン" src="https://img.shields.io/badge/version-0.8.1-2e6cc4?labelColor=d4eaf7">
    </a>
</p>
...
- **v0.8.1** — **検索パフォーマンス**（BM25 キーワード結果キャッシュ＋コーパスバージョン連動無効化；embedding 再試行/LRU/singleflight；高次元ベクトルで `ivfflat.probes=8`；キャッシュテストのフレーク除去）。加えてリポジトリ衛生：ローカルデプロイ成果物の追跡を停止。詳細は [`CHANGELOG.md`](./CHANGELOG.md)。
